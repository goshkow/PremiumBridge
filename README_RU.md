...
PremiumBridge — это менеджер premium-сессий для оффлайн-серверов Minecraft Java. Версия 1.0.5 поддерживает Minecraft Java 1.21.9-1.21.11, 26.1.x и 26.2 одним backend-JAR.
